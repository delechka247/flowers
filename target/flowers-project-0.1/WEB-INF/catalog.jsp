                            ...
                            <div class="text-center pl-0 pr-0 container d-flex flex-row ">
                                ...
                                <div class="block col-md-6 col-xl-3 ">
                                    <div class="card shadow " style="width: auto">
                                        <img src="https://sun9-67.userapi.com/slCzrgrN0oMdA4Y9IgRpI-ojwHdtxqUNbiONIw/9NHjPDiI7zA.jpg"
                                             class="card-img-top" alt="Red roses">
                                        <div class="card-body p-0">
                                            <h5 class="card-title pt-1 mb-1">Гортензия</h5>
                                            <div class="text-center">
                                                <small><b>Цена:</b> 2000р</small>
                                            </div>
                                            <div class="scroll">
                                                <p class="card-text p-2">Если вы хотите показать кому-то, насколько
                                                    цените
                                                    его помощь и присутствие,
                                                    гортензия для этого подходит лучше всего. Также этот красивый
                                                    цветок
                                                    является символом более
                                                    глубокого понимания между двумя людьми, как между друзьями и
                                                    членами
                                                    семьи, так и романтической
                                                    парой.</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="block col-md-6 col-xl-3 ">
                                    <div class="card shadow " style="width: auto">
                                        <img src="https://sun9-76.userapi.com/kfNxuARtBz6ZiWS2W8IGa3Y4xic-cy3F-E4D-w/lnFUjeV6E4k.jpg"
                                             class="card-img-top" alt="Red roses">
                                        <div class="card-body p-0">
                                            <h5 class="card-title pt-1 mb-1">Пионы</h5>
                                            <div class="text-center">
                                                <small><b>Цена:</b> 3000р</small>
                                            </div>
                                            <div class="scroll">
                                                <p class="card-text p-2">Обладая чувственным и притягательным
                                                    ароматом,
                                                    пион
                                                    также является отличным
                                                    лекарством для привлечения любви и романтики. Символически и
                                                    метафорически пион являет собой
                                                    воплощение женственности и женской красоты.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="block col-md-6 col-xl-3 ">
                                    <div class="card shadow " style="width: auto">
                                        <img src="https://sun9-66.userapi.com/aW7O42NUc1aZDLrqwGXvuZC_eEjkgsv6Ad2VIA/spnlOg2R6oI.jpg"
                                             class="card-img-top" alt="Red roses">
                                        <div class="card-body p-0">
                                            <h5 class="card-title pt-1 mb-1">101 Красная роза</h5>
                                            <div class="text-center">
                                                <small><b>Цена:</b>10000р</small>
                                            </div>
                                            <div class="scroll">
                                                <p class="card-text p-2">
                                                    Красные розы – воплощение любви и душевного притяжения,
                                                    подаренные
                                                    любимому человеку, розы найдут путь в его сердце и поселят там
                                                    счастье и
                                                    радость</p>
                                            </div>
                                        </div>
                        ...
                        <div class="scroll pl-0" style="width: 105%; height: 380px">
                            ...
                            <fieldset class="form-group pt-3">
                                <div class="row text-left">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check col-md-12 row">
                                            <input class="form-check-input col-md-4" type="checkbox" name="gridRadios"
                                                   id="dl_14"
                                                   value="14">
